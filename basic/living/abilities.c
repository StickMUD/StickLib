...
// They shouldn't see these. They must notice it... /Graah
#if 0
	      case ST_HP_HEAL_RATE:
		s2 = "You feel your flesh regenerating faster."; break;
	      case ST_SP_HEAL_RATE:
		s2 = "You feel your mental power regenere faster."; break;
	      case ST_FP_HEAL_RATE:
		s2 = "You feel your exhaustion disappearing faster."; break;
#else
	      case ST_HP_HEAL_RATE:
	      case ST_SP_HEAL_RATE:
	      case ST_FP_HEAL_RATE:
...
#if 0
	      case ST_HP_HEAL_RATE:
		s2 = "You feel your wounds healing slower."; break;
	      case ST_SP_HEAL_RATE:
		s2 = "You feel your mental power heal slower."; break;
	      case ST_FP_HEAL_RATE:
		s2 = "You feel your exhaustion disappears slower."; break;
#else
	      case ST_HP_HEAL_RATE:
	      case ST_SP_HEAL_RATE:
	      case ST_FP_HEAL_RATE:
