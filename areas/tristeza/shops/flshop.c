...
// Why has this been off? -+ Doomdark +-
// Please do comment things...

/* They use it for harrasment! //Graah */
...
// Um. I presume this is for logging flower sending.
// Or something... We live in a police mud! :-)
// -+ Doomdark +-
...
{
  notify_fail(
"The shop doesn't work now, thanks to jerks who use it to harrass \
other players! Try again in a few years!\n");
  return 0;
}
...
deliver2(string str) {
   ...
   // These things can be used in illegal ways (harrassment), so Police is
   // interested in who sends naughty messages and to whom...
#if 0
   POLICED->write_log(FLWRLOG,(string)this_player()->query_real_name()+" sent flowers to "
