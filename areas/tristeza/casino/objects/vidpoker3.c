/******************************************************************
  vidpoker3.c
  Casino magic red poker machine (Joker Wild Ace-King video poker) 
  Coded by: Germ
  Last modified: Feb 13, 96

  Modification history:
    (2/13/95) - fixed minor scoring bug
  ...
  The payoffs and winning hands are the same as Joker-wild ace-king
...
#define GAME_LOG "LOGS/VIDPOKER3.LOG"
...
void create_treasure()
{
  ...
  string desc;
   ...
   desc = "It is a large machine painted red with the familiar\
 ...
 <a> <b> <c>\' where a,b,c are the card numbers to discard\n.";
  ...
  set_short("A magical red poker machine");
  set_long( desc );
...
status read_cmd(string arg)
{
  ...
  write("The payoffs for this machine are:\n\n\
    ...
    ----------------------------------------------------\n\
     Natural Royal Flush         200000       2000000\n\
     5 of a Kind                 100000        250000\n\
     Royal Flush with Joker       50000        125000\n\
     Straight Flush               25000        125000\n\
     4 of a Kind                  10000         50000\n\
     Full House                    3500         20000\n\
     Flush                         2500         17500\n\
     Straight                      1500         12500\n\
     3 of a Kind                   1000          5000\n\
     Two Pair                       500          2500\n\
     Pair of Aces or Kings          500          2500\n\n");
