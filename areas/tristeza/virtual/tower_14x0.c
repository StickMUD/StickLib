...
// 10-Sep-98, Doomdark: Not completely rewritten; shouldn't have
//	have the hatch if no priest guild included with the mudlib
...
#ifdef GN_PRIEST
#define	ROOM_UNDER_US	GUILD_PATH_PRIEST "crypt/virtual/under_tower"
#endif
